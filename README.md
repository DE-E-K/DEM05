...
> A production-ready data analytics pipeline demonstrating enterprise-grade data engineering practices with Apache Spark, async APIs, and advanced analytics.
...
| **ETL** | Apache Spark 3.5+ | JSON files | Parquet (partitioned) | Clean, transform, enrich data |
...
|-----------|-----------|---------|---------|
| **Distributed Processing** | Apache Spark | 3.5+ | ETL at scale |
